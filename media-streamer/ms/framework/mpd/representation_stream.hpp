...
public:
    ...
    virtual dash::mpd::ISegment *get_initialization_segment() const = 0;
    virtual dash::mpd::ISegment *get_index_segment(std::size_t segment_number) const = 0;
    virtual dash::mpd::ISegment *get_media_segment(std::size_t segment_number) const = 0;
    virtual dash::mpd::ISegment *get_bitstream_switching_segment() const = 0;
